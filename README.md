...
[![GoDoc](https://godoc.org/github.com/etherdev12/go-binance?status.svg)](https://godoc.org/github.com/etherdev12/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/etherdev12/go-binance)](https://goreportcard.com/report/github.com/etherdev12/go-binance)
...
```shell
go get github.com/etherdev12/go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/etherdev12/go-binance/v1
```
...
import (
    ...
    "github.com/etherdev12/go-binance/v2"
    
    "github.com/etherdev12/go-binance/v2/futures" // optional package
    "github.com/etherdev12/go-binance/v2/delivery" // optional package
    "github.com/etherdev12/go-binance/v2/options" // optional package
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/etherdev12/go-binance) for full references.
